...
Today is <HijriNow />, which corresponds to <DateNow /> Gregorian. (This is updated every day @ 00:00 UTC)

import HijriNow from '../../../components/HijriNow.astro';
import DateNow from '../../../components/DateNow.astro';